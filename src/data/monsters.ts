...
export const MONSTER_UNITS_CATALOG: MonsterUnitDefinition[] = [
  ...
  },
  {
    ...
    aliases: ['Cavaleiro da Morte', 'Cavaleiro', 'Cavalgante'],
    tier: 3,
    family: 'cursed',
    subType: 'Amaldiçoado, Unidade montada',
    troopClass: 'mounted',
  ...
  },
  {
    ...
    aliases: ['Cavaleiro de Cão da Morte', 'Cão da Morte'],
    tier: 2,
    family: 'undead',
  ...
  },
  {
    ...
    aliases: ['Cavaleiro das Trevas', 'Cavaleiro da Morte', 'Cavalgante'],
    tier: 4,
    family: 'undead',
    subType: 'Unidade montada, Morto-vivo',
    troopClass: 'mounted',
